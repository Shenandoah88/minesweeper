...
let submitButtonExisting = document.getElementById("submitExisting");
submitButtonExisting.addEventListener("submit", hashJavaOld);

let submitButtonNew = document.getElementById("submitNew");
submitButtonNew.addEventListener("submit", hashJavaNew);
